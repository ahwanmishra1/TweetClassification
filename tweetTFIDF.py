...
tfidf = TfidfVectorizer(max_features = 100, stop_words = getStopWordList('stopwords.txt').append('at_user'))
X = tfidf.fit_transform(text).todense()
np.savetxt("ddd.csv", X, delimiter=",")
##with open('dataset.csv', 'w') as tf:
##    tf.write(X)
#main3()